...
import 'package:ads_manager/view/banner/ads_manager_banner.dart';
import 'package:ads_manager/view/native/ads_manager_native.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Ads Manager ExampleR'),
    );
  }
}
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                _adsManager.showRewardedAd(
                  adsManagerRewardsListner: (isRewarded) {
                    // ignore: avoid_print
                    print("Hallo isRewarded: $isRewarded");
                  },
                );
              },
            ...
            if (_isShowBanner)
              AdsManagerBannerView(
                configAdsManager: _configAdsManager,
              ),
            if (_isShowNative)
              AdsManagerNativeView(
                configAdsManager: _configAdsManager,
              ),
          ],
        ),
